...
class Ui_ccdcontroller(object):
    def setupUi(self, ccdcontroller):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(21, 10, 751, 321))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 719, 275))
        ...
        self.comboBox.addItem(_fromUtf8(""))
        self.comboBox.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.comboBox, 5, 0, 2, 1)
        self.monoLabel = QtGui.QLabel(self.layoutWidget)
        self.monoLabel.setObjectName(_fromUtf8("monoLabel"))
        self.gridLayout.addWidget(self.monoLabel, 7, 0, 1, 1)
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(20, 340, 751, 231))
    ...
    def retranslateUi(self, ccdcontroller):
        ...
        self.filterLabel.setText(_translate("ccdcontroller", "Filter:", None))
        ...
        self.comboBox.setItemText(0, _translate("ccdcontroller", "u", None))
        self.comboBox.setItemText(1, _translate("ccdcontroller", "g", None))
        self.comboBox.setItemText(2, _translate("ccdcontroller", "r", None))
        self.comboBox.setItemText(3, _translate("ccdcontroller", "i", None))
        self.comboBox.setItemText(4, _translate("ccdcontroller", "z", None))
        self.comboBox.setItemText(5, _translate("ccdcontroller", "y", None))
        self.monoLabel.setText(_translate("ccdcontroller", "Monochromator:", None))
