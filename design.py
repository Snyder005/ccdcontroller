...
class Ui_ccdcontroller(object):
    def setupUi(self, ccdcontroller):
        ...
        ccdcontroller.resize(613, 272)
        self.centralWidget = QtGui.QWidget(ccdcontroller)
        self.centralWidget.setObjectName(_fromUtf8("centralWidget"))
        self.tabWidget = QtGui.QTabWidget(self.centralWidget)
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 596, 215))
        ...
        self.gridLayout.addWidget(self.exposeButton, 0, 0, 3, 1)
        ...
        self.gridLayout.addWidget(self.imfilenameLabel, 5, 1, 1, 1)
